...
import com.lifeops.truthservice.common.CorrelationConstants;
import com.lifeops.truthservice.dto.error.ApiErrorResponse;
import com.lifeops.truthservice.dto.error.FieldErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TruthAnalysisNotFoundException.class)
    public ResponseEntity<ApiErrorResponse> handleTruthAnalysisNotFoundException(TruthAnalysisNotFoundException exception, HttpServletRequest request){
